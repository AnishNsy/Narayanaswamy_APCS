...
class ImageComponent extends JComponent implements KeyListener{
    ...
    String[][] grid = HivoltsRepresentative.getGrid();
    ...
    public ImageComponent(){
    	addKeyListener(this);
        try{
            File image2 = new File("src\\Fence.png");
            File image1 = new File("src\\Happy.png");
            File image3 = new File("src\\Mho.png");
